...
4. **Route segments** (`route_segments`): tramo ejecutable por el robot asociado a una arista. Guarda el CSV con la ruta grabada. `expected_duration_seconds` aqui solo registra cuanto tarda la grabacion — **no** es el peso del grafo.
